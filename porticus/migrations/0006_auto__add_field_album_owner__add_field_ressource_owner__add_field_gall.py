...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'porticus_album', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ressource.owner'
        db.add_column(u'porticus_ressource', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gallery.owner'
        db.add_column(u'porticus_gallery', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'porticus_album', 'owner_id')

        # Deleting field 'Ressource.owner'
        db.delete_column(u'porticus_ressource', 'owner_id')

        # Deleting field 'Gallery.owner'
        db.delete_column(u'porticus_gallery', 'owner_id')
    ...
    models = {
        ...
        u'porticus.ressource': {
            'Meta': {'ordering': "('album', 'priority')", 'unique_together': "(('album', 'slug'),)", 'object_name': 'Ressource'},
